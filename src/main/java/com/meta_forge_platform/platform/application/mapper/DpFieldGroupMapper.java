...
public interface DpFieldGroupMapper extends BaseMapper<
        DpFieldGroup,
        DpFieldGroupDto,
        DpFieldGroupSummaryDto,
    ...
    @Override
    List<DpFieldGroupDto> toDtoList(List<DpFieldGroup> entities);

    @Override
    List<DpFieldGroupSummaryDto> toSummaryDtoList(List<DpFieldGroup> entities);
}