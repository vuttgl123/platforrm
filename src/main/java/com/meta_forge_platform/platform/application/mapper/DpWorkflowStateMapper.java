...
public interface DpWorkflowStateMapper extends BaseMapper<
        DpWorkflowState,
        DpWorkflowStateDto,
        DpWorkflowStateSummaryDto,
    ...
    @Override
    List<DpWorkflowStateDto> toDtoList(List<DpWorkflowState> entities);

    @Override
    List<DpWorkflowStateSummaryDto> toSummaryDtoList(List<DpWorkflowState> entities);
}