...
public interface DpWorkflowTransitionMapper extends BaseMapper<
        DpWorkflowTransition,
        DpWorkflowTransitionDto,
        DpWorkflowTransitionSummaryDto,
    ...
    @Override
    List<DpWorkflowTransitionDto> toDtoList(List<DpWorkflowTransition> entities);

    @Override
    List<DpWorkflowTransitionSummaryDto> toSummaryDtoList(List<DpWorkflowTransition> entities);
}