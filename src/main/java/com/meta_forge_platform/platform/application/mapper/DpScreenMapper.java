...
public interface DpScreenMapper extends BaseMapper<DpScreen, DpScreenDto, DpScreenSummaryDto, CreateDpScreenCmd, UpdateDpScreenCmd> {
    ...
    @Override List<DpScreenDto> toDtoList(List<DpScreen> entities);
    @Override List<DpScreenSummaryDto> toSummaryDtoList(List<DpScreen> entities);
}