...
public interface DpFieldOptionMapper extends BaseMapper<DpFieldOption, DpFieldOptionDto, DpFieldOptionSummaryDto, CreateDpFieldOptionCmd, UpdateDpFieldOptionCmd> {
    ...
    @Override List<DpFieldOptionDto> toDtoList(List<DpFieldOption> entities);
    @Override List<DpFieldOptionSummaryDto> toSummaryDtoList(List<DpFieldOption> entities);
}