...
public interface DpScreenSectionMapper extends BaseMapper<
        DpScreenSection,
        DpScreenSectionDto,
        DpScreenSectionSummaryDto,
    ...
    @Override
    List<DpScreenSectionDto> toDtoList(List<DpScreenSection> entities);

    @Override
    List<DpScreenSectionSummaryDto> toSummaryDtoList(List<DpScreenSection> entities);
}