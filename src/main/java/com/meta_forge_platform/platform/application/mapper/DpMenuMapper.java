...
public interface DpMenuMapper extends BaseMapper<
        DpMenu,
        DpMenuDto,
        DpMenuSummaryDto,
        CreateDpMenuCmd,
    ...
    @Override
    List<DpMenuDto> toDtoList(List<DpMenu> entities);

    @Override
    List<DpMenuSummaryDto> toSummaryDtoList(List<DpMenu> entities);
}