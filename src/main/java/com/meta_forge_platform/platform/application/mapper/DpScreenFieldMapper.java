...
@Mapper(
        ...
        uses = {DpScreenMapper.class, DpFieldMapper.class},
        nullValuePropertyMappingStrategy = NullValuePropertyMappingStrategy.IGNORE,
        builder = @Builder(disableBuilder = true)
)
public interface DpScreenFieldMapper extends BaseMapper<
        DpScreenField,
        DpScreenFieldDto,
        DpScreenFieldSummaryDto,
    ...
    @Override
    List<DpScreenFieldDto> toDtoList(List<DpScreenField> entities);

    @Override
    List<DpScreenFieldSummaryDto> toSummaryDtoList(List<DpScreenField> entities);
}