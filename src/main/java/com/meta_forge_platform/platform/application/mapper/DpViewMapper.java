...
public interface DpViewMapper extends BaseMapper<DpView, DpViewDto, DpViewSummaryDto, CreateDpViewCmd, UpdateDpViewCmd> {
    ...
    @Override List<DpViewDto> toDtoList(List<DpView> entities);
    @Override List<DpViewSummaryDto> toSummaryDtoList(List<DpView> entities);
}