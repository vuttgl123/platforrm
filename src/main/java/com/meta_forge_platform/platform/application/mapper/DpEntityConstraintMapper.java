...
public interface DpEntityConstraintMapper extends BaseMapper<DpEntityConstraint, DpEntityConstraintDto, DpEntityConstraintSummaryDto, CreateDpEntityConstraintCmd, UpdateDpEntityConstraintCmd> {
    ...
    @Override List<DpEntityConstraintDto> toDtoList(List<DpEntityConstraint> entities);
    @Override List<DpEntityConstraintSummaryDto> toSummaryDtoList(List<DpEntityConstraint> entities);
}