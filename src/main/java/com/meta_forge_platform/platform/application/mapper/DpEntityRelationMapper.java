...
public interface DpEntityRelationMapper extends BaseMapper<
        DpEntityRelation,
        DpEntityRelationDto,
        DpEntityRelationSummaryDto,
    ...
    @Mapping(target = "mappedByField", source = "ownerField")
    ...
    @Mapping(target = "ownerField", ignore = true)
    @Mapping(target = "inverseField", ignore = true)
    ...
    @Override
    List<DpEntityRelationDto> toDtoList(List<DpEntityRelation> entities);

    @Override
    List<DpEntityRelationSummaryDto> toSummaryDtoList(List<DpEntityRelation> entities);
}