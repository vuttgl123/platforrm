...
public interface DpWorkflowMapper extends BaseMapper<DpWorkflow, DpWorkflowDto, DpWorkflowSummaryDto, CreateDpWorkflowCmd, UpdateDpWorkflowCmd> {
    ...
    @Override List<DpWorkflowDto> toDtoList(List<DpWorkflow> entities);
    @Override List<DpWorkflowSummaryDto> toSummaryDtoList(List<DpWorkflow> entities);
}